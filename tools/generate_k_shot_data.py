...
def process_seed(seed, k, datasets, output_dir, mode):
    print("Seed = %d" % (seed))
...
def main():
    ...
    pool.map(partial(process_seed, k=k, datasets=datasets, output_dir=args.output_dir, mode=args.mode), args.seed)
