#mkdir -p ../out/fewshot_128_similar_separate_mul_contrastive
#parallel -j4 --lb -n 3 'arr=(na 0 1 2 3); python fewshot_similar_contrastive.py {1} {2} {3} 128 separate_labels mul "[1, 2, 4, 8, 16]" ${arr[{%}]} |& tee ../out/fewshot_128_similar_separate_mul_contrastive/{1}.txt' ::: \
#    SST-2 sst-2 2 \
#    cr cr 2 \
#    mr mr 2 \
#    QQP qqp/f1 2 \
...
mkdir -p ../out/fewshot_16_similar_separate_mul_contrastive
parallel -j4 --lb -n 3 'arr=(na 0 1 2 3); python fewshot_similar_contrastive.py {1} {2} {3} 16 separate_labels mul "[1, 2, 4, 8, 16]" ${arr[{%}]} |& tee ../out/fewshot_16_similar_separate_mul_contrastive/{1}.txt' ::: \
    QQP qqp/f1 2 \
    sst-5 sst-5 5 \
    MNLI mnli 3 \
    SNLI snli 3 \
